...
class LahanController extends Controller
{
        ...
        $detail_id = $request->id;
            ...
            $mainRelation = [
                ...
                "key1" => [
                    ...
                    "table_alias" => "L",
                    "reference_column" => "farmer_no",
                    "display" => ['name', 'ktp_no', 'ktp_document', 'address', 'farmer_profile', "post_code"],
    ...
    public function createFarmerLahanMOU_new(Request $request){
       $validator = Validator::make($request -> all(),[
            'farmer_no' => 'required',
            'lahan_no' => 'required',
            'mou_no' => 'required',
        ...
        if($validator->fails()){
            ...
            $createDatas = [
                    "0" => ['table_header' => 'farmer_no',              'table_new_data' => $request->farmer_no,            'type' => 'string'],
                    "1" => ['table_header' => 'lahan_no',               'table_new_data' => $request->lahan_no,             'type' => 'string'],
                    "2" => ['table_header' => 'mou_no',                 'table_new_data' => $request->mou_no,               'type' => 'string'],
                    "3" => ['table_header' => 'program_year',           'table_new_data' => $request->program_year,         'type' => 'string'],
                    "4" => ['table_header' => 'mou_status',             'table_new_data' => $request->mou_status,           'type' => 'int'],
                    "5" => ['table_header' => 'mou_file',               'table_new_data' => $request->mou_file,             'type' => 'string'],
                    "6" => ['table_header' => 'mou_revision_reason',    'table_new_data' => $request->mou_revision_reason,  'type' => 'string'],
                    "7" => ['table_header' => 'land_ownership_photo',   'table_new_data' => $request->land_ownership_photo, 'type' => 'string'],
                    "8" => ['table_header' => 'land_not_sengketa_photo',    'table_new_data' => $request->land_not_sengketa_photo,  'type' => 'string'],
                    "9" => ['table_header' => 'sign_reject_reason',     'table_new_data' => $request->sign_reject_reason,   'type' => 'string'],
                    "10" => ['table_header' => 'verified_at',           'table_new_data' => $request->verified_at,          'type' => 'string'],
                    "11" => ['table_header' => 'polygon_image',         'table_new_data' => $request->polygon_image,        'type' => 'string'],
                    "12" => ['table_header' => 'land_proof_photo',      'table_new_data' => $request->land_proof_photo,     'type' => 'string'],
                    "13" => ['table_header' => 'signed_at',             'table_new_data' => $request->signed_at,            'type' => 'string'],
                    "14" => ['table_header' => 'printed_status',        'table_new_data' => $request->printed_status,       'type' => 'int'],
                    "15" => ['table_header' => 'printed_at',            'table_new_data' => $request->printed_at,           'type' => 'string'],
                ];
