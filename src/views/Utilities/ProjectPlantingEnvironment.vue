  ...
  data() {
    return {
      config: {
        ...
        permission: {
          create: "project-planting-environment-create",
          read: "project-planting-environment-list",
          update: "project-planting-environment-update",
          detail: "project-planting-environment-detail",
          lookup: "project-planting-environment-lookup",
          delete: "project-planting-environment-delete",
        },
        slave: [],
        fields: [
          {
