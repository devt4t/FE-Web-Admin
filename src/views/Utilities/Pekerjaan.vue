    ...
    >
      <template v-slot:top>
        <v-toolbar flat class="rounded-xl">
          ...
          <v-btn
            ...
            @click="showAddModal()"
            color="green"
            v-if="$_sys.isAllowed('pekerjaan-create')"
          >
      ...
      <template v-slot:item.actions="{ item }">
        <v-icon
          ...
          @click="editItem(item)"
          color="warning"
          v-if="$_sys.isAllowed('pekerjaan-update')"
        >
          mdi-pencil
        </v-icon>
        <v-icon
          ...
          color="red"
          v-if="$_sys.isAllowed('pekerjaan-delete')"
        >
          mdi-delete
        </v-icon>
      </template>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { text: "Nama Pekerjaan", value: "name" },
  ...
  methods: {
    ...
    async verifDelete() {
      ...
      try {
        const response = await axios.post(
          this.BaseUrlGet + "DeletePekerjaan",
          datapost,
          {
            headers: {
              Authorization: `Bearer ` + this.authtoken,
    ...
    async updateData() {
      ...
      try {
        const response = await axios.post(
          this.BaseUrlGet + "UpdatePekerjaan",
          datapost,
          {
            headers: {
              Authorization: `Bearer ` + this.authtoken,
