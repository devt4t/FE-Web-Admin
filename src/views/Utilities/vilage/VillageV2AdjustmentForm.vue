              ...
              <v-row class="assign-ff-wrapper" v-if="village_data">
                <v-col lg="12" class="form-separator">
                  <div class="d-flex flex-row align-items-center">
                    ...
                    <v-btn variant="success" class="add-button ml-2" @click="addTaDesa()" small>
                ...
                <v-col lg="12" v-for="(taDesa, i) in ta_desa" :key="'taDesa-' + i">
                  <v-row class="mx-3 bg-grey">
                    <v-col lg="6">
                      <geko-input v-model="taDesa.program_year" :item="{
                        label: 'Tahun Program',
                        type: 'select',
                        validation: ['required'],
                        option: {
                    ...
                    <v-col lg="5">
                      <geko-input v-model="taDesa.area_code" :item="{
                        type: 'select',
                        label: 'Target Area',
                        validation: ['required'],
                    ...
                    <v-col lg="1" class="mt-0 pt-0 d-flex flex-column" style="
                        ...
                        ">
                      <v-btn small variant="danger" class="btn-icon" @click="removeTADesa(i)">
