<template>
  <div>
    ...
    <!-- DIALOGS -->
        ...
        <v-card>
          <v-form ref="form" v-model="valid" lazy-validation>
            <v-card-title class="mb-1 headermodalstyle">
              <span class=""><v-icon class="mr-2" color="white">mdi-account-details</v-icon>{{ formTitle }}</span>
            </v-card-title>
            ...
            <v-card-text>
              ...
              <v-container v-if="load == false">
                <v-row>
                  ...
                  <v-col cols="12" sm="4" md="4">
                    <v-menu v-model="menu2" transition="scale-transition" content-class="rounded-xl">
            ...
            <v-card-actions v-if="load == false">
              ...
              <v-spacer></v-spacer>
              <v-btn color="green darken-1" class="px-5" rounded outlined @click="save"><v-icon class="mr-1">mdi-content-save</v-icon> Save </v-btn>
            </v-card-actions>
          </v-form>
        </v-card>
      </v-dialog>
      ...
      <!-- Eport Dialog -->
      <ExportModal :show="showExportModal" :data="dataobject" @close="() => showExportModal = false" />
