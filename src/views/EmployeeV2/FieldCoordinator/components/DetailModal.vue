    ...
    >
        <v-card>
            ...
            <v-card-text class="pa-0" style="min-height: 300px;">
                ...
                <!-- export table -->
                <div id="containerForExport-Employee-FieldCoordinator" style="display: none">
...
export default {
    ...
    methods: {
        ...
        exportReport() {
            const container = document.getElementById("containerForExport-Employee-FieldCoordinator");
            var vm = this, word = `
            ...
            // XLSX.writeFile(wb, `ExportEmployee-FieldCoordinator.xlsx`);
        },
        async getData(id) {
            try {
                this.loading.show = true
