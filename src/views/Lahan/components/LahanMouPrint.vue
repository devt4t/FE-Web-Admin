    ...
    <v-dialog v-model="isOpen" width="850" scrollable>
      <v-card>
        <v-card-title class="d-flex flex-row justify-content-between mb-5">
          <h4 class="mb-0 pb-0" v-if="openFormUpload">{{ formUploadPreview ? 'Preview' : 'Upload' }} Lampiran</h4>
          ...
          <div class="d-flex" v-if="!openFormUpload">
            ...
            <!-- btn upload berkas -->
            <v-btn
              v-if="mouData && mouData.printed_status && mouData.mou_status != 5"
              :disabled="loading"
              small
              variant="warning"
              class="d-flex flex-row align-items-center ml-2"
              @click="openFormUpload = true;formUploadPreview = false;"
            >
            ...
            <!-- btn preview berkas -->
            <v-btn
              v-if="mouData && mouData.printed_status && [4,5].includes(mouData.mou_status)"
              :disabled="loading"
              small
              variant="success"
              class="d-flex flex-row align-items-center ml-2"
              @click="openFormUpload = true;formUploadPreview = true;"
            >
        ...
        <v-card-text>
          <v-alert v-if="mouData && mouData.printed_at && !openFormUpload"
            dense
            text
  ...
  methods: {
    ...
    onOpen() {
      ...
      if (this.mouData && [1,4,5].includes(this.mouData.mou_status)) {
        ...
        if ([4,5].includes(this.mouData.mou_status)) this.formUploadPreview = true;
