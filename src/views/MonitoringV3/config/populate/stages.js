export const POPULATE_STAGE_REGISTRY = {
    ...
    '1-to-2': {
        ...
        targetMonitoring: 2,
        api: {
            list: 'monitorings-v3/populate/list',
            assignment: 'monitorings-v3/populate/assignment',
            resetAssignment: 'monitorings-v3/populate/resetAssignment',
            generateMonitoring: 'monitorings-v3/populate/generateMonitoring',
            delete: 'monitorings-v3/populate/delete',
        },
        features: {
            hasExport: false,
        },
