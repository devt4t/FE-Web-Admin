                        ...
                        <table class="farmer-lahan geko-table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Total MPTS</th>
                                    <th>Total Bibit</th>
                                    <th style="max-width: 100px">Persetujuan<br />Carbon</th>
                                    <th>MOU Petani</th>
                                    <th>Kehadiran</th>
                                </tr>
                            </thead>
                                ...
                                <tr v-for="(farmer, i) in lahans" :key="`farmer-land-${i}`" :class="{
                                    ...
                                    <td class="text-left">
                                        <div class="d-block" v-if="farmer.bordered">
                                            ...
                                            <span class="badge d-block mt-3" :class="{
                                    ...
                                    <td>
                                        ...
                                        <geko-input v-if="farmer.project_purpose_code == 'carbon'"
                                            v-model="farmer.legal_agreement_status" :item="{
                                                label: 'Persetujuan Carbon',
                                                hide_label: true,
                                                validation: ['required'],
                                                type: 'select-radio',
                                                setter: 'legal_agreement_status',
                                                option: {
                                                    default_options: [
                                                        {
                                                            label: 'Ya',
                                    ...
                                    <td>
                                        ...
                                        <geko-input v-model="farmer.legal_agreement"
                                            v-if="farmer.project_purpose_code == 'carbon'" :item="{
                                                label: 'Foto MOU',
                                                hide_label: true,
                                                validation: ['required'],
                                                type: 'upload',
                                                api: 'planting-socialization/upload-new.php',
                                                directory: 'mou',
                                                upload_type: 'image/*',
                                                setter: 'legal_agreement',
                                                view_data: 'legal_agreement',
                                                option: {
                                                    label_hint:
...
<script src="./PlantingSocForm.new.js">
</script>