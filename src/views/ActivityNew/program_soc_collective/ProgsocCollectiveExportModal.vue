<template>
    <v-dialog v-model="isOpen" width="50%">
        <template v-slot:default="{ isActive }">
            <v-card>
                <v-card-title>
                    <span>Export Sosialisasi Program Collective</span>
                </v-card-title>
    ...
    data() {
        return {
            ...
            configUrl: {
                ...
                excel: `${this.$_config.baseUrlExport}export/soc-prog-collective/excel`,
            }
        };
    },
    props: {
    ...
    methods: {
        ...
        getExportDataCarbon(value, offset) {
            return new Promise(async (resolve, reject) => {
                ...
                this.$_api
                    .get("GetFormMinatCollectiveAll_new", payload)
                    .then((res) => {
                        return resolve(res);
                    })
                    .catch(() => {
