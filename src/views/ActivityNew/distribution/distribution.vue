          ...
          <v-card-text>
            ...
            >
              <v-progress-circular
                ...
                width="7"
              ></v-progress-circular>
              <p class="mt-2">Sedang Mengambil Data Bibit...</p>
            </div>
            <div v-else>
              <v-row v-if="calendar.detailBibit.datas">
                ...
                <v-col cols="12">
                  <v-simple-table>
                    <tbody>
                      <tr>
                        <td style="width: 150px">Tahun Program</td>
                        <td>:</td>
              ...
              <v-row>
                <v-col cols="6" md="3" lg="3">
                  <v-row class="align-center my-2 ml-2">
                    <v-icon class="mr-1">mdi-printer</v-icon> Label Tercetak
      ...
      <v-container fluid>
        ...
        >
          ...
          <v-select
            ...
            :items="$_config.programYear ? $_config.programYear.options :  ['2021', '2022', '2023', '2024', '2025']"
                    ...
                    <v-card-text class="white">
                      <v-simple-table class="rounded-xl">
                        <tbody>
                          ...
                          <tr>
                            <td>Total Field Facilitators</td>
                            <td>:</td>
