  ...
  methods: {
    async uploadPdfManual(file) {
      ...
      if (file.size > maxSize) {
        this.$_alert.error("Gagal! Ukuran file melebihi batas maksimal 3MB");
    ...
    async initData() {
      ...
      const keys = [
        ...
        ["next_event_contact_person_number", "next_event_contact_person_number"],
    ...
    onSubmit() {
      ...
      let payload = {
        ...
        next_event_contact_person_number: this.formData.next_event_contact_person_number,
