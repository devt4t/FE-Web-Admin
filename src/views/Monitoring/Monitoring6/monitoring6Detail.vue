<template>
  <div>
    <v-row>
      <v-col>
        <v-card data-aos="fade-up" data-aos-delay="100" data-aos-duration="800" class="geko-base-detail-card mb-1">
          <v-data-table :headers="headerBibits" :items="data.result.monitoring_tree_detail" :search="''"
    ...
    <v-row>
      <v-col>
        <v-card data-aos="fade-up" data-aos-delay="100" data-aos-duration="800" class="geko-base-detail-card mb-1">
          <v-data-table :headers="DetailPerSeeds.header" :items="DetailPerSeeds.items" :search="''"
            class="rounded-xl elevation- pa-1 px-5" :footer-props="{
              showCurrentPage: false,
              showFirstLastPage: false,
            }">
      ...
      <v-col>
        <v-card data-aos="fade-up" data-aos-delay="100" data-aos-duration="800" class="geko-base-detail-card mb-5 px-4">
          ...
          <div class="text-center mb-3">
            <v-progress-circular :rotate="360" :size="200" :width="20" :value="data.result.life_tree_percentage"
        ...
        <v-card data-aos="fade-up" data-aos-delay="100" data-aos-duration="800" class="geko-base-detail-card mb-5 px-4">
          ...
          <div class="absent-photo-list d-flex flex-row" v-if="true">
            <div class="absent-photo-item"
              @click="showLightbox($_config.baseUrlUpload + '/' + data.result.photo1 ?? '')" v-bind:style="{
                backgroundImage:
                  'url(' +
            ...
            <div class="absent-photo-item"
              @click="showLightbox($_config.baseUrlUpload + '/' + data.result.photo2 ?? '')" v-bind:style="{
                backgroundImage:
                  'url(' +
                  $_config.baseUrlUpload +
                  '/' +
