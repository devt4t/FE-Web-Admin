<template>
    <v-dialog v-model="isOpen" width="50%">
        <template v-slot:default="{ isActive }">
            <v-card>
                <v-card-title>
                    <span>Export Summary Monitoring 2</span>
                </v-card-title>
                                ...
                                <v-row>
                                    ...
                                    <v-col lg="12">
                                        <v-btn variant="danger" type="submit" v-if="format == 'pdf'">
                                            <v-icon v-if="!loadingExportByFF">mdi-file-pdf-box</v-icon>
                                    ...
                                    <v-col lg="12">
                                        <v-btn variant="success" type="submit" v-if="format == 'excel'">
                                            <v-icon v-if="!loadingExportByFF">mdi-microsoft-excel</v-icon>
                                            <v-progress-circular v-else :size="20" color="danger"
                                                indeterminate></v-progress-circular>
...
export default {
    name: "lahan-export-summary-modal",
    data() {
        return {
            ff_no: null,
            mu_no: null,
            ...
            configUrl: {
                ...
                excel: `${this.$_config.baseUrlExport}export/monitoring2-summary/excel`,
            }
        };
    },
    props: {
    ...
    methods: {
        ...
        getExportData(ffCode) {
            return new Promise(async (resolve, reject) => {
                this.$_api
                    .get("second-monitorings/main/export", {
        ...
        getExportDataCarbon(value, offset) {
            return new Promise(async (resolve, reject) => {
                ...
                this.$_api
                    .get("second-monitorings/main/export", payload)
                    .then((res) => {
                        return resolve(res);
                    })
                    .catch(() => {
