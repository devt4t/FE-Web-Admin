...
//NEW GEKO API
    ...
    public function GetNewScoopingAll(Request $request){
        ...
        $field = [
            ...
            'project_id',
            'potential_status',
            'potential_status_description',
            'other_ngo',
            'resident_acceptance',
            'next_event_contact_person',
            'general_land_condition',
            'field_companion_potency',
            'ff_candidate',
            'email_to_gis',
            'gis_officer',
            'gis_verify_at'
        ...
        $validator = Validator::make($request -> all(), [
            ...
            if($validator->fails()){
                ...
                if($request->delete_type == 'soft_delete'){
                    ...
                    return response()->json([
                        'main_result' => $mainScoopingQuery,
                        'figures_result' => $ScoopingFiguresQuery,
                        'ngo_result' => $ScoopingNGOQuery,
                        'project_result' => $ScoopingProjectQuery,
                        ], 200);
    ...
    public function GetNewRraPraAll(Request $request) {
        ...
        public function deleteRraPra_new(Request $request){
            ...
            // 'rra_no' => 'required',
            // 'pra_no' => 'required',
            'per_modul_delete' => 'required', //rra /pra/ both
            ...
            if($validator->fails()){
                ...
                if($request->delete_type == 'soft_delete'){
                    ...
                    if($request->per_modul_delete == 'rra'){
                    ...
                    else if($request->per_modul_delete == 'pra'){
                    ...
                    else if($request->per_modul_delete == 'both'){
                        // RRA
                        $mainRraQuery = $this->DynamicDelete([
                            'current_id' => $request->rra_no,
                            'tableName' => 'rras',
