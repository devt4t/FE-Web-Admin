...
class RraPraController extends Controller
{
    ...
    public function GetNewScoopingAll(Request $request)
    {
        ...
        if (isset($request->has_rra)) {
            $filterable['rra_id'] = [
                'request_value' => $request->has_rra == "0" ? "NULL" : "NOT NULL",
                'table_alias' => 'H',
                'operator' => 'IS',
                'is_nullable' => true
            ];
        ...
        $query = $this->DynamicList([
            ...
            'concatConditionIndex' => 'F.id',
            'concatCondition' => 'IS NULL',
            'concatConditionValue' => "'No Project Found'",
            'req' => $req,
            'users_id' => $user_id
        ]);
    ...
    public function AddScoopingVisit_new(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $createDatas = [
                ...
                "42" => ['table_header' => 'next_event_contact_person_number', 'table_new_data' => $request->next_event_contact_person_number, 'type' => 'string'],
            ];
    ...
    public function AddScoopingVisitFFCandidate_new(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'data_no' => 'required',
            'name' => 'required',
        ...
        if ($validator->fails()) {
            ...
            $tableName = 'scooping_visit_ff_candidate';
            $createDatas = [
                "0" => ['table_header' => 'data_no', 'table_new_data' => $request->data_no, 'type' => 'string'],
                "1" => ['table_header' => 'name', 'table_new_data' => $request->name, 'type' => 'string'],
                "2" => ['table_header' => 'phone', 'table_new_data' => $request->phone, 'type' => 'string'],
                "3" => ['table_header' => 'whatsapp', 'table_new_data' => $request->whatsapp, 'type' => 'string'],
    ...
    public function AddScoopingProject_new(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (in_array($request->project_id, $projectData)) {
                ...
                $updateMainData = [
                    "0" => ['table_header' => 'is_verify', 'table_new_data' => 0, 'type' => 'string'],
                    "1" => ['table_header' => 'verified_by', 'table_new_data' => NULL, 'type' => 'string'],
                    "2" => ['table_header' => 'verified_at', 'table_new_data' => NULL, 'type' => 'string'],
                    "3" => ['table_header' => 'updated_at', 'table_new_data' => Carbon::now()]
                ];
                $mainDatas = $this->DynamicUpdate([
                    'current_id' => $request->data_no,
                    'tableName' => 'scooping_visits',
                    'inputData' => $updateMainData,
                    'other_id_index' => 'data_no',
                    'id_data_type' => 'string'
                ]);

                $mainResult = DB::update($mainDatas);
                $result = DB::insert($datas);
                return response()->json([
                    'result' => $result,
    ...
    public function UpdateScoopingVisit_new(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $updateDatas = [
                ...
                "34" => ['table_header' => 'updated_by', 'table_new_data' => Auth::user()->email, 'type' => 'string'],
                "35" => ['table_header' => 'updated_at', 'table_new_data' => Carbon::now()],
                "36" => ['table_header' => 'program_year', 'table_new_data' => $request->program_year, 'type' => 'int'],
                "37" => ['table_header' => 'potential_status', 'table_new_data' => $request->potential_status, 'type' => 'int'],
                "38" => ['table_header' => 'potential_status_description', 'table_new_data' => $request->potential_status_description, 'type' => 'string'],

                "39" => ['table_header' => 'other_ngo', 'table_new_data' => $request->other_ngo, 'type' => 'string'],
                "40" => ['table_header' => 'resident_acceptance', 'table_new_data' => $request->resident_acceptance, 'type' => 'string'],
                "41" => ['table_header' => 'next_event_contact_person', 'table_new_data' => $request->next_event_contact_person, 'type' => 'string'],
                "42" => ['table_header' => 'general_land_condition', 'table_new_data' => $request->general_land_condition, 'type' => 'string'],
                "43" => ['table_header' => 'field_companion_potency', 'table_new_data' => $request->field_companion_potency, 'type' => 'string'],
                "44" => ['table_header' => 'ff_candidate', 'table_new_data' => $request->ff_candidate, 'type' => 'string'],
            ];
    ...
    public function UpdateScoopingVisitFigures_new(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $this->createScoopingLog($logData);
    ...
    public function UpdateScoopingVisitFFCandidate_new(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'current_id' => 'required',
            'data_no' => 'required',
    ...
    public function GetDetailScoopingVisitAll_new(Request $request)
    {
    ...
    public function GetDetailScoopingVisitFFCandidate_new(Request $request)
    {
        $id = $request->data_no;
        ...
        $condition = [
            "data_no" => [
                "conditional_table" => "scooping_visit_ff_candidate",
                "conditional_table_alias" => "A",
                "conditional_param" => "=",
                "conditional_value" => "'" . $request->data_no . "'",
            ],
    ...
    public function UpdateVerifScoopingVisitGIS_new(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($getVerificationStatus->is_verify == 0) {
                $updateDatas = [
                    "0" => ['table_header' => 'gis_officer', 'table_new_data' => Auth::user()->email, 'type' => 'string'],
            ...
            } else if ($getVerificationStatus->is_verify == 1) {
                $updateDatas = [
                    "0" => ['table_header' => 'gis_officer', 'table_new_data' => Auth::user()->email, 'type' => 'string'],
                    "1" => ['table_header' => 'gis_verify_at', 'table_new_data' => Carbon::now()],
                    "2" => ['table_header' => 'status', 'table_new_data' => 'submit_review', 'type' => 'string'],
                    "3" => ['table_header' => 'is_verify', 'table_new_data' => '2', 'type' => 'int'],
                    "4" => ['table_header' => 'dry_land_area', 'table_new_data' => $request->dry_land_area, 'type' => 'int'],
                    "5" => ['table_header' => 'slope', 'table_new_data' => $request->slope, 'type' => 'string'],
                    "6" => ['table_header' => 'altitude', 'table_new_data' => $request->altitude, 'type' => 'string'],
                    "7" => ['table_header' => 'rainfall', 'table_new_data' => $request->rainfall, 'type' => 'string'],
    ...
    public function DeleteScoopingVisitFFCandidate_new(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'id' => 'required',
            'delete_type' => 'required'
    ...
    public function GetNewRraPraAll(Request $request)
    {
        ...
        $userid = ' AND TRUE ';
        // return response()->json(implode(", ",$employeeUser),200);
        if (count($employeeUser) > 0) {
            $userid = " AND A.user_id IN ('" . implode("', '", $employeeUser) . "') ";
        }
        $sql = "
            SELECT
            ...
            WHERE (C.id IS NOT NULL or D.id IS NOT NULL)" . $userid . " 
    ...
    public function testRRAGetter_test(Request $request)
    {
        $employeeUser = $this->getFCListByUserUMPY('2023');
        return response()->json(['test' => $employeeUser], 200);
    }
    ...
    public function addMainRra_new(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $result = DB::insert($datas);
            $lastId = "SELECT MAX(id + 1) as current_id FROM rras";
            $last_id_result = DB::select($lastId);
            return response()->json([
                'result' => $result,
    ...
    public function MailtoGis(Request $request)
    {
        ...
        Mail::send(['html' => $template_path], $data, function ($message) use ($request) {
            ...
            $message->to('haryadi@trees4trees.org', 'Mas Haryadi')->subject('[GEKO Mailing]Scooping Visit GIS Mailing');
    ...
    public function MailToSocialOfficer(Request $request)
    {
        ...
        Mail::send(['html' => $template_path], $data, function ($message) use ($request) {
            ...
            $message->to('irvan.maulana@trees4trees.org', 'eaunggelia.triandi@trees4trees.org')->subject('[GEKO Mailing] Scooping Visit Social Officer Mailing');
            // Set the sender
    ...
    private function createScoopingLog($logData)
    {
        // user auth data
        $user = Auth::user();
        // set message
        $message = $logData['status'] . ' ' . $logData['table'] . ' ' . $logData['msg'] . ' ' . ' by ' . ($user['email'] ?? '-');


        $log = Log::channel('scooping_visit');
